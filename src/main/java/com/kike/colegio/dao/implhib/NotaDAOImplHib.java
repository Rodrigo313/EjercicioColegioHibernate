...
public class NotaDAOImplHib implements NotaDAO {
	...
	public List<NotaDTO> obtenerNotaPorIdNombreAsignaturaNotaFecha(String idAlumno, String nombre, String asignatura,
		...
		String jpql = "select new com.kike.colegio.dtos.NotaDTO (n.id, a.id, a.nombre, asi.id, asi.nombre, n.nota, n.fecha) "
				+ "FROM NotaEntity n INNER JOIN AlumnoEntity a ON n.alumnos.id = a.id "
				+ "INNER JOIN AsignaturasEntity asi ON n.asignaturas.id = asi.id "
